#!/bin/bash
# ================================================================================================
# Wrapper script to compute DP mean/var, sample phenotypes, call PRS-CS, and perform GOPHER-MultiLP
# ================================================================================================
...
for eps in "${eps_list[@]}"; do
    ...
    # -------------------------
    # Step 3: Run GOPHER-MultiLP mechanism
    # -------------------------
...
echo "Completed DP phenotype generation, PRS computation, and MultiLP processing."
