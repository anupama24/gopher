#!/bin/bash
# ================================================================================================
# Wrapper script to compute DP mean/var, sample phenotypes, call PRS-CS, and perform GOPHER-MultiQP
# ================================================================================================
...
for eps in "${eps_list[@]}"; do
    ...
    # -------------------------
    # Step 3: Run GOPHER-MultiQP mechanism
    # -------------------------
...
echo "Completed DP phenotype generation, PRS computation, and MultiQP processing."
